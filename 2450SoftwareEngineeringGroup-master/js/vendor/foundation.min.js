function _classCallCheck(t, e) {
        ...
        a = {
            ...
            reflow: function(e, i) {
                ...
                t.each(i, function(i, a) {
                    var r = o._plugins[a],
                        s = t(e).find("[data-" + a + "]").addBack("[data-" + a + "]");
                    s.each(function() {
                        var e = t(this),
                            i = {};
    ...
    var r = function(n) {
        var i = typeof n,
            ...
            r = t(".no-js");
        if (o.length || t('<meta class="foundation-mq">').appendTo(document.head), r.length && r.removeClass("no-js"), "undefined" === i) a.MediaQuery._init(), a.reflow(this);
        else {
    ...
    window.Foundation = a, t.fn.foundation = r,
        function() {
    ...
    var n = {
        ...
        _init: function() {
            ...
            n = e(o);
            for (var a in n) n.hasOwnProperty(a) && i.queries.push({
                name: a,
    ...
    function e(t, e, i, o) {
        ...
        if (e) {
            var u = n(e);
            r = f.offset.top + f.height <= u.height + u.offset.top, a = f.offset.top >= u.offset.top, s = f.offset.left >= u.offset.left, l = f.offset.left + f.width <= u.width + u.offset.left
        } else r = f.offset.top + f.height <= f.windowDims.height + f.windowDims.offset.top, a = f.offset.top >= f.windowDims.offset.top, s = f.offset.left >= f.windowDims.offset.left, l = f.offset.left + f.width <= f.windowDims.width;
        var d = [r, a, s, l];
        return i ? s === l == !0 : o ? a === r == !0 : -1 === d.indexOf(!1)
    }
    ...
    function i(t, e, i, o, a, r) {
        ...
        switch (i) {
            ...
            case "center bottom":
                return {
                    left: r ? a : l.offset.left + l.width / 2 - s.width / 2,
            ...
            case "right bottom":
                return {
                    left: l.offset.left + l.width + a - s.width,
                    top: l.offset.top + l.height
                };
            default:
                return {
    ...
    function e(t, e, n) {
        function i(s) {
            r || (r = window.performance.now()), a = s - r, n.apply(e), t > a ? o = window.requestAnimationFrame(i, e) : (window.cancelAnimationFrame(o), e.trigger("finished.zf.animate", [e]).triggerHandler("finished.zf.animate", [e]))
        }
        var o, a, r = null;
    ...
    function n(e, n, a, r) {
        function s() {
            e || n.hide(), l(), r && r.apply(n)
        }

        function l() {
            n[0].style.transitionDuration = 0, n.removeClass(f + " " + u + " " + a)
        }
        if (n = t(n).eq(0), n.length) {
            var f = e ? i[0] : i[1],
                u = e ? o[0] : o[1];
            l(), n.addClass(a).css("transition", "none"), requestAnimationFrame(function() {
                n.addClass(f), e && n.show()
    ...
    }), t(document).on("focus.zf.trigger blur.zf.trigger", "[data-toggle-focus]", functifunction _classCallCheck(t, e) {
            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
        }! function(t) {
            "use strict";
            ...
            var n = {
                ...
                o = {
                    ...
                    handleKey: function(e, n, o) {
                        ...
                        if (a = "undefined" == typeof l.ltr ? l : Foundation.rtl() ? t.extend({}, l.ltr, l.rtl) : t.extend({}, l.rtl, l.ltr), r = a[f], s = o[r], s && "function" == typeof s) {
                            var u = s.apply();
            ...
            var o = function() {
                ...
                return _createClass(e, [{
                    ...
                    value: function() {
                        ...
                        }, this.isMobile = i(), this.$anchor = t(t('[data-open="' + this.id + '"]').length ? '[data-open="' + this.id + '"]' : '[data-toggle="' + this.id + '"]'), this.$anchor.attr({
                    ...
                    key: "_makeOverlay",
                    value: function(e) {
                        var n = t("<div></div>").addClass("reveal-overlay").appendTo("body");
                        return n
                    }
                }, {
                    key: "_updatePosition",
                    value: function() {
                        var e, n, i = this.$element.outerWidth(),
                            o = t(window).width(),
                            a = this.$element.outerHeight(),
                            r = t(window).height();
                        e = "auto" === this.options.hOffset ? parseInt((o - i) / 2, 10) : parseInt(this.options.hOffset, 10), n = "auto" === this.options.vOffset ? a > r ? parseInt(Math.min(100, r / 10), 10) : parseInt((r - a) / 4, 10) : parseInt(this.options.vOffset, 10), this.$element.css({
                            top: n + "px"
                    ...
                    value: function() {
                        ...
                        this.$element.on({
                            ...
                            "close.zf.trigger": function(i, o) {
                                return i.target === n.$element[0] || t(i.target).parents("[data-closable]")[0] === o ? e.close.apply(e) : void 0
                            },
                    ...
                    value: function() {
                        var e = this;
                        this.focusableElements = Foundation.Keyboard.findFocusable(this.$element), this.options.overlay || !this.options.closeOnClick || this.options.fullScreen || t("body").on("click.zf.reveal", function(n) {
                            n.target === e.$element[0] || t.contains(e.$element[0], n.target) || e.close()
                    ...
                    value: function() {
                        function e() {
                            n.isMobile ? (t("html, body").removeClass("is-reveal-open"), n.originalScrollPos && (t("body").scrollTop(n.originalScrollPos), n.originalScrollPos = null)) : t("body").removeClass("is-reveal-open"), n.$element.attr("aria-hidden", !0), n.$element.trigger("closed.zf.reveal")
                        }
